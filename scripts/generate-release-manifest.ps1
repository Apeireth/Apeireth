...
.DESCRIPTION
    ...
    generates the SHA256SUMS file, and creates the authoritative releaseon.
...
# Scan Artifacts
$IgnoreFiles = @("SHA256SUMS", "SHA256SUMS.sig", "releaseon", "releaseon.sig")
...
$ManifestPath = Join-Path $FullDistDir "releaseon"
