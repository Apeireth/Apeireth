...
| 字段 | 值 |
|------|----|
| 路径 | `.前代产品-worktrees/integrations/527f21de-e3e3-4dcc-a90d-d022bec6d5e5` |
...
```bash
cd /d/repo
git -C .前代产品-worktrees/integrations/527f21de-e3e3-4dcc-a90d-d022bec6d5e5 rev-parse HEAD
git -C .前代产品-worktrees/integrations/527f21de-e3e3-4dcc-a90d-d022bec6d5e5 symbolic-ref --short HEAD
git -C .前代产品-worktrees/integrations/527f21de-e3e3-4dcc-a90d-d022bec6d5e5 rev-list --left-right --count master...HEAD
git worktree list
```
...
执行序列 (5 步):
1. **Worktree 探针**: 验证 `.前代产品-worktrees/integrations/527f21de-*` 存在 + 可 git 读
