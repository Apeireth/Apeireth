...
| P3-2 | L13 (§0 表) + L243 (末行 r12on) | `reports/r12-baseline-verification-2026-07-30.json` (243 行, 结构化结果) | `242 lines` (`wc -l reports/r12-baseline-verification-2026-07-30.json`) | **-1** |
