...
| 禁止项 | 检查方式 | 结果 |
|---|---|---|
| ❌ 不 commit `.前代产品-worktrees/` | `git log --name-only c4271293~1..46a27773 \| grep 前代产品-worktrees` | ✅ 0 命中 |
...
| 路径 | 类型 | 原因（不动原因）|
|---|---|---|
| `.前代产品-worktrees/r10-ao-retry2` | modified | worktree 元数据（任务禁止项）|
| `.前代产品-worktrees/integrations/e8de47ae-.../integration/` | untracked | worktree 元数据（任务禁止项）|
