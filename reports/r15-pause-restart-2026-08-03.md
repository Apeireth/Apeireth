...
cd ..
ls .前代产品-worktrees/ -ErrorAction SilentlyContinue
git -C .前代产品-worktrees/integrations/* status --short 2>&1 | Select-Object -First 20
...
| **重启团队** | 主人 + 楚零 | 通过 前代产品 MCP 或手动 spec spawn 新 team instance |
...
| **状态机** | 前代产品 MCP team_finalize | 已知卡死，**不要尝试调用** |
