...
| VCP 真字段 / 命令 (FileOperator.js + pluginon) | Rust const / method | 真值 |
|----------------------------------------------------------|-------------------|------|
...
| `pluginon:55 command: "ReadFile"` | `FileOps::read` | (操作映射) |
| `pluginon:63 command: "WriteFile"` | `FileOps::write` | (操作映射) |
| `pluginon:79 command: "ListDirectory"` | `FileOps::list` | (操作映射) |
| `pluginon:99 command: "DeleteFile"` | `FileOps::delete` | (操作映射) |
| `pluginon:91 command: "MoveFile"` | `FileOps::move_path` | (操作映射) |
| `pluginon:103 command: "CreateDirectory"` | `FileOps::mkdir` | (操作映射) |
| `pluginon:59 command: "WebReadFile"` (HTTP GET 模式) | `WebSearch::search` | (模式借鉴) |
