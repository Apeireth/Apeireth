...
| **S-3 质量工程化借鉴点** | **ResourceQuota 设计** (CPU/RAM/IO 三维预算 + 自动截断); 进 `apeireth-supervisor::resource_guard` (借鉴 前代产品 MA-4 的 ConcurrencyGuard + smolvm 的三维预算, **不打乱 MA-4 已规划的位置**) |
...
- 资源预算思路跟 前代产品 ConcurrencyGuard 互补 (资源多了 → 隔离强; 不冲突)
...
- `C:\Users\31683\Apeireth-rust\reports\前代产品-multiagent-borrow-survey-2026-08-19.md` (ConcurrencyGuard 可借鉴基底, MA-4)
