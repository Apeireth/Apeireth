...
To .openclaw/workspace/promethean/.前代产品-worktrees/integrations/527f21de-e3e3-4dcc-a90d-d022bec6d5e5
...
worktree remote 配置默认 ref 是 `rebase/d7d8-into-integration`，但 前代产品
