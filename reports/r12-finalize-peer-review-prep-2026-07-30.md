...
| 40 | **working tree 文件数** | T16 §3 "T2 审计通过, 6 atomic commit 建议" | 153 (git status 短行数) + **26 files +1122/-254 modified + mvp/ ~22 untracked + 16 _append*.py + 6 .前代产品-worktrees/** | n/a (T16 §3 简略, 实际更复杂) | **P1** |
