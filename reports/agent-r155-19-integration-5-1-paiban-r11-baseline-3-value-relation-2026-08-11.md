...
**R11 baseline 3 值** (per `docs/conventions/11-baseline.md` §3 + `docs/versioning/05-metric.md` §1 + `CHANGELOG.md` L141-142 + L328 + L402 + `apeireth-legacy/README.md` §1 + `docs/stage5/stage5-construction-document.md` §6 + `docs/stage5/construction-kickoff-manual.md` §2 + `docs/stage4/v09021-rust-translation-blueprint-2026-08-05.md` §3 + `docs/stage4/v09021-commercial-extract-2026-08-05.md` §3 + `docs/stage4/tauri-team-collab-sop-2026-08-05.md` §6 + `docs/stage4/tauri-assets-from-前代产品-2026-08-05.md` §5 + `docs/stage4/stage4-thinking-document.md` §3 + `docs/stage4/stage4-correction-v10-versioning-system.md` §3):
