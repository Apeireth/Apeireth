...
```mermaid
flowchart TD
    A[Step 0 起点 verify<br/>整合 #5.1 + 5.2 commit 拍板 ready 估 8/11 04:30+<br/>整合 #4 abf12243 + 整合 #5.3 4207f187 + 整合 #5.1 + 整合 #5.2<br/>master HEAD = 4 commit 衔接 100%<br/>per 决策 #62 + 决策 #78 + 决策 #81] --> B[Step 1 V1.0 release 实战 8 步 runbook 续<br/>整合 #5 commit 拍板 done verify + 配 remote + push + 删 stale + 打新 v1.0.0 tag + release + GitHub Pages + verify<br/>主人起床后手跑 8/11 06:00-10:15 70 min<br/>per R149-5 §1.1 8 步 + R147-1 §2 + R138-5 §2 + 决策 #11]
    B --> C[Step 1.5 V1.1 release 调研 + 差距 + 计划 + 实施 永久循环 4 步<br/>R144 调研 + R145 差距 + R146 计划 + R147 实施<br/>含 整合 #6 + #7 commit 拍板 + V1.1 release 实战<br/>估 8/12 - 11/30 永久循环 0 终点<br/>per 决策 #71 §2-§5 + 主人 0:57 拍板 + R138-3]
    C --> D[Step 2 整合 #6 commit 拍板<br/>Mavis 自决拍板 6.1 → 6.2 → 6.3 顺序 git add + git commit<br/>主人起床后手跑 8 步 runbook 70 min<br/>2026-11-25 06:00-12:00<br/>per 决策 #62 + 决策 #78 Option A 拍板 模式 + 决策 #74 B1 V1.1 release Mavis 自决改 + 决策 #74 B2 Cargo.toml 1.2.1 bump + 决策 #74 A3 PHL-07 V1.1 实施 + R134-3 5 阶段 4 周 + 2 天 + R138-6 + R151-1 §2]
    D --> E[Step 2.5 V1.1 release 续 7.1 src/ + 7.2 docs/ + 7.3 reports/ 拍板准备 3 阶段 1 周<br/>2026-11-26 → 2026-11-29<br/>per R138-7 §1.2 3 阶段 1 周 + R134-4 §1.1 + 决策 #62 整合 #5 commit 3 commit 类比 + 决策 #74 B1]
    E --> F[Step 3 整合 #7 commit 拍板<br/>Mavis 自决拍板 7.1 → 7.2 → 7.3 顺序 git add + git commit<br/>主人起床后手跑 8 步 runbook 70 min<br/>2026-11-29 06:00-12:00<br/>per 决策 #62 整合 #5 commit 3 commit 类比 + 决策 #74 B1 V1.1 release Mavis 自决改 + R138-7 3 阶段 1 周 + R134-4 + R151-2 §2]
    F --> G[Step 4 V1.1 release 实战 8 步 runbook<br/>Mavis 自决拍板 + 主人手跑<br/>2026-11-30 06:00-08:00 主人手跑 40-70 min<br/>per R151-2 §2.5 + R136-2 §3 + R138-7 §6 + 决策 #11 类比 + 决策 #33 C1]
    G --> H[Step 5 V1.2 release 永久循环接续<br/>Mavis 主动 永久循环 0 终点<br/>4 步循环 → 含 整合 #8 + #9 + #10 commit 拍板 + V1.2 release 实战<br/>估 V1.2 release 2027-02-28<br/>per 决策 #71 §2-§5 + 主人 0:57 拍板 + R130-5 §1.3 + R132-1 §1.3]
    H --> I[🎉 V1.1 release done<br/>永久循环 V1.2 release 启动<br/>V2.0 release 远期 2027+ 8 硬墙可重评 + 8 哲学锚可重建<br/>per 决策 #74 §2.3 + ROADMAP.md §4]
```
...
| **Step 2** | 主人起床后配 GitHub remote (per 决策 #33 C1 0 主动 push, 0 Mavis 主动 配 remote) | **5 min** (估 2026-11-30 06:10 done) | 0 主动 push (per 决策 #33 C1 + 决策 #61 §6) | 主人手跑: `git remote add origin https://github.com/Apeireth/Apeireth` (跟 1.0 release 实战 Step 2 类比) | ✅ 0 越界 | 决策 #11 + 决策 #33 §2.3 + 决策 #58 §7 + 决策 #61 §6 + 决策 #74 §3.3 + 决策 #78 §3 |
...
| 2 | verify remote 已存在 (1.0 release 实战 Step 2 已配过) | `git remote -v` 显示 origin = https://github.com/Apeireth/Apeireth.git | 主人 (脚本执行) | ✅ |
...
| 6 | verify GitHub Release v1.1.0 创建成功 | https://github.com/Apeireth/Apeireth/releases/tag/v1.1.0 | 主人 (浏览器 verify) | ✅ |
...
| # | 子步 | URL / 命令 | 主动方 | 通过判据 |
|---:|------|------|:------:|---------|
| 1 | verify GitHub release v1.1.0 页面 | https://github.com/Apeireth/Apeireth/releases/tag/v1.1.0 | 主人 (浏览器) | title "Apeireth 1.1.0" + notes (RELEASE_NOTES.md V1.1 release) + assets (源码 tarball/zip) |
