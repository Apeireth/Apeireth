...
| 决策 | 选项 | R21 续补 |
|------|------|---------:|
| **apeireth-formal** FormalEngine impl 跨 4 backend | (A) rebuild 1:1 镜像 v0.9.21 / (B) 维持 HEAD 状态 (lib.rs:30 `pub mod invariants;` + Cargo.toml 0 dependencies) + R21 补 invariants module 真接 | ~1-2 天 (跟 4 backend × 4 async fn = 16 impl 估补) |
