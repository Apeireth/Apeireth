...
6 哲学锚穿透 + 8 项不修改承诺守门 (per voice/sandbox 报告 §3):
  - S-1 北极星: 5 SDK 1:1 翻译 v0.9.21 (TTS=OpenAI 1:1/STT=Whisper 1:1/
...
新文件 ~50 个 (~6,800 行):
  - 12 ADR (替换老的 12 个, 估 ~3,075 行):
    ...
    * docs/adr/0010-6-philosophy-anchors.md (替换 0010-mcp-from-前代产品-agentmcpserver)
    * docs/adr/0011-tui-as-thin-client.md (替换 0011-apeireth-team-lead-supervisor)
    * docs/adr/0012-前代产品-reverse-engineering.md (替换 0012-team-lead-council-collaboration)
    + 14 旧 ADR 删 (per D 标记)
