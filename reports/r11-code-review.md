...
if v04_score is None:
    ...
    v04_score = 0.8538  # R9 W4 末 baseline — provenance: r9-w4on
```

```python
# V1130
# 主 17:43 实事求是: 默认值必须显式 provenance
# v04_score=0.8538 = R9 W4 末 baseline (provenance: r9-w4on, ASI 北极星 LOCKED 0.9800)
# v1074_v03_score=0.8897 = R9 守门 ≥ 0.8884 (provenance: r9-guard-floor)
parser.add_argument("--v04", type=float, default=0.8538, help="...; provenance: r9-w4on")
