//! # apeireth-keyring
//!
//! **P0 凭证安全 crate** — 1:1 翻译 v0.9.21 `keychain-token-storage` (~12KB).
//!
...
/// 1:1 翻译 v0.9.21 `getPassword(key)` 返 string 类型.
...
// 1:1 翻译 v0.9.21 rate-limiter.js, 防 min m3 m3 hallucination 调用爆破.
...
// 1:1 翻译 v0.9.21 keychain 文件 checksum.
// ============================================================================
...
// 1:1 翻译 v0.9.21 keychain-token-storage.js 的 5 主入口.
