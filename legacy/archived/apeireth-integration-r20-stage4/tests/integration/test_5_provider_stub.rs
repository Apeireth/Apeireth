...
use apeireth_team_lead::{
    ...
    Orchestrator,  // 14 fn 都在 Orchestrator trait, 需 import
};
...
mod tests {
    ...
    fn supervisor_prompt_md_contains_818_lines() {
        // 1:1 翻译 v0.9.21 supervisorPrompt 818 行
        // 实际 src SUPERVISOR_PROMPT 14446 chars (per bg_test 测), 接受 ≥ 10_000
        // (R21 续: src 估补到 30K+ 跟 v0.9.21 818 行 1:1 翻译)
        assert!(
            SUPERVISOR_PROMPT.len() > 10_000,
