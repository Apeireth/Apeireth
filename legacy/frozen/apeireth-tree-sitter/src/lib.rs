...
//!
//! 1:1 翻译 v0.9.21 `tree-sitter-bash` (2.9MB obfuscated) +
...
//! ## 6 哲学 anchor 穿透
//!
//! - **S-1 北极星导向**: 1:1 翻译 v0.9.21 tree-sitter 集成面, 0 业务重设计
//! - **S-2 实事求是**: 商业版 `tree-sitter-*` 实查估 2000 LOC 总, skeleton 阶段估 600 行 (3x 缩), R20 阶段 4 续
...
/// 1:1 翻译 v0.9.21 tree-sitter 8 主 grammar. R20 阶段 4 续只接 4 (Rust/TS/Python/Bash), 其它 4 留后续.
...
// ============================================================================
// §2 核心枚举: Language 8 项 (1:1 翻译 v0.9.21 8 grammar)
// ============================================================================

/// 支持的语言枚举 (8 项, 1:1 翻译 v0.9.21 tree-sitter 8 grammar).
///
