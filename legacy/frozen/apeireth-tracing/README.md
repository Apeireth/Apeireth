...
本 crate 是 Apeireth R20 阶段 6 估补的 distributed tracing 框架, 1:1 翻译 v0.9.21 `@anthropic-ai/tracing` (per docs/stage4/v09021-rust-translation-blueprint-RIVAL §2.x tracing 部分).
...
- **S-2 主 17:43 实事求是** — 1:1 翻译 v0.9.21, 0 业务重设计
