...
//! - VCP `Plugin/<X>/pluginon` 17KB 字段结构借鉴为 Tool 4 方法最小集
...
///
/// **4 方法**:
/// 1. `name()` — 工具唯一名 (e.g. `"FileOperator"`, 跟 VCP `Plugin/<X>/pluginon:name`)
...
///
/// **借鉴**: VCP `Plugin/<X>/pluginon` 字段 (description / version / author)
#[derive(Debug, Clone)]
