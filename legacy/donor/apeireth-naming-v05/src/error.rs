...
pub enum NamingError {
    ...
    /// lineage 不在 4 血统内 (前代产品-0.9/apeireth-0.14/apeireth-1.0/apeireth-2.0).
    #[error("invalid lineage: '{0}', must be one of 前代产品-0.9/apeireth-0.14/apeireth-1.0/apeireth-2.0")]
