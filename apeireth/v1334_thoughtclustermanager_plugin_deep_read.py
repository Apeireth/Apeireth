...
| F2  | plugin manifest         | pluginon              |              70    |  2978  | computed     |
...
class TCMManifestSnapshot:
    """Parsed pluginon with key safety boundaries."""
...
def parse_tcm_manifest(manifest_path: Path) -> TCMManifestSnapshot:
    """Parse pluginon into TCMManifestSnapshot."""
...
def _self_test() -> Dict[str, bool]:
    ...
    manifest = parse_tcm_manifest(TCM_ROOT / "pluginon")
