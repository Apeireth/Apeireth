...
### 2. 商业版 1:1 翻译 (前代产品 前身)

| 借鉴 | 用在哪 | 协议 |
|------|--------|------|
| **前代产品 0.9.21** (前身, 2024-2025) | 全部 67 crate 1:1 翻译 (per `docs/stage3-blueprints/borrowed-from-r11.md`) | Apache-2.0 |
...
| 3 | **前代产品 0.9.21 前身 1:1 翻译**: 67 crate 全部来自前身翻译 | per `docs/stage3-blueprints/borrowed-from-r11.md` (LOCKED 阶段 3) |
