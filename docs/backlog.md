...
| 29 | README crate 计数修正 | A4 (AR2 b74fc48b) | README 写「81 (80 顶层 + 嵌套)」, 实测 workspace members=82 (81 顶层 + 1 嵌套) | ✅ README active crate 行改 81→82、80→81 顶层（`cargo metadata --no-deps` 实测 82=81 顶层 + memory/extensions 嵌套, 提交 da7055d, 任务 405f81f4）|
