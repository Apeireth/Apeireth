# ADR 0023: 前代产品 0.9.21 1:1 翻译 — Apeireth Rust 重写的"对标基础"
...
- **API 一致**: HTTP API schema 跟 前代产品 0.9.21 100% 兼容 (per ADR 0017 D-01)
- **数据兼容**: SQLite 5 表 schema 跟 前代产品 0.9.21 100% 兼容 (per ADR 0020 D-07)
