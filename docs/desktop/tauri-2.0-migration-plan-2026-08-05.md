...
**关联**: v0.9.21 Electron → Tauri 2.0 终极前端路线
...
**Tauri 2.0 角色**: 1.0 release 终极前端, 1:1 翻译 v0.9.21 Electron API
...
- v0.9.21 `out/main/index.js` (6 BrowserWindow / 8 Menu / 1 Tray / 161 ipcMain / 34 dialog / 102 shell)
