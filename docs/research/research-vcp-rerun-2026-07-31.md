...
| 启用插件 | **65** | `Plugin/*/pluginon` |
| 禁用插件 | **20** | `Plugin/*/pluginon.block` |
...
证据：`Plugin/SciCalculator/pluginon:17-26`、`modules/vcpLoop/toolCallParser.js`。
...
证据：`Plugin/AgnesVideoGen/pluginon:1-82`。
...
证据：`Plugin/LightMemo/pluginon`、`Plugin/LightMemo/LightMemo.js:104-151`。
...
- `Plugin/SciCalculator/pluginon:1-32`
- `Plugin/AgnesVideoGen/pluginon:1-82`
- `Plugin/LightMemo/pluginon:1-51`
...
- `Plugin/RAGDiaryPlugin/pluginon:1-44`
