...
| ADR | 文件 | 大小 | 摘要 |
|---|---|---:|---|
| [ADR-0010](adr/0010-mcp-from-前代产品-agentmcpserver.md) | mcp-from-前代产品-agentmcpserver | 12.7KB | mcp 翻译决策 |
...
| 文件 | 大小 | 摘要 |
|---|---:|---|
| `stage4/前代产品-integration-blueprint-r19-plus-2026-08-05.md` | 60.9KB | 0 蓝图 |
...
| 文件 | 大小 | 摘要 |
|---|---:|---|
| `stage4/tauri-assets-from-前代产品-2026-08-05.md` | 15.9KB | 13 项 T-001~T-013 |
| `stage4/tauri-team-collab-sop-2026-08-05.md` | 22.8KB | Tauri SOP |
| `stage4/glossary-前代产品-additions-2026-08-05.md` | 11.1KB | 8 词条 |
...
| 文件 | 大小 | 摘要 |
|---|---:|---|
| `../../前代产品/reports/r19-risks-v2-2026-08-05.md` | 31.4KB | 30 风险总表 (P0/P1/P2) |
...
R19+ 集成期 reports/ 15 份, 见 `../../前代产品/reports/README.md`.

### 关联文档 (Mermaid / 风险 / 收口)

- `stage4/r19-integration-mermaid-overview-2026-08-05.md` — 6 张 Mermaid 总览图
- `../../前代产品/reports/r19-risks-v2-2026-08-05.md` — 30 项风险总表
- `../../前代产品/reports/r19-integration-wrap-up-v2-2026-08-05.md` — v2 总收口