...
| **原因** | 通常是 cosign key 错 / bundle 错 / 1.0 release 阈值 1-of-1 (per `0012-前代产品-reverse-engineering.md`) |
...
- [../../docs/adr/0012-前代产品-reverse-engineering.md](../../docs/adr/0012-前代产品-reverse-engineering.md) — 1.0 release 阈值 1-of-1
