...
>
> **本节草稿目标**: 让学术研究者 **1 跳** 看到 BibTeX 引用 + 前身 (前代产品 0.9.21) 致敬 + 6 哲学锚入口.
>
...
| 项目 | 时间 | 关系 | 协议 |
|------|------|------|------|
| **前代产品 0.9.21** (前身商业版) | 2024-2025 | 67 crate 1:1 翻译来源 | Apache-2.0 |
...
| 2 | **5 前身致敬表**: 前代产品 0.9.21 + VCPChat + Yinta + Hermes + m3 | per DEPENDENCY §5 + ROADMAP.md §R19 关键产物 |
