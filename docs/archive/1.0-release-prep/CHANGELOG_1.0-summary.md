...
| 12 | **0012** | 前代产品 0.9.21 1:1 翻译 | 🟢 Accepted | 翻译基线 | `docs/stage4/v09021-commercial-extract-2026-08-05.md` (250 行) | — |
...
| 8 | 0023 (旧) | 前代产品 reverse engineering | 0012 | `archive/r20-pre-renumber/0023-前代产品-reverse-engineering.md` |
...
| 15-21 | 0001-0012 (旧 R14) | R14 历史 12 条 | — | `archive/r14/0001-...` ~ `0012-...md` (双洋葱 / CLI-Session API 绑定 / 22 trait 互锁 / 权限洋葱 / 风险等级 M1-M12 / 集成 rebase-skip / 兼容组件层 / Feature gating pybridge / MCP from 前代产品 / team-lead supervisor / team-lead council) |
...
**关键决策**: 蓝图 RIVAL VERSION 替代原版预告 `bg_a5470979` (卡住 20+ min 0 output), 对齐 7 项 + 差异 8 项 (1:1 翻译 v0.9.21 14 crate, 5 阶段 320h 实施, 8 项不修改承诺, 6 哲学锚, m3 5 道防御, 8 闭源处理, 60+ SDK 分类).
...
### 2.12 [0012] 前代产品 0.9.21 1:1 翻译

> **状态**: 🟢 Accepted (R20 阶段 1 主人 2026-08-05 19:37 拍板全用 rust 1:1 翻译)
> **commit 锚**: `docs/stage4/v09021-commercial-extract-2026-08-05.md` (250 行, 安装包分析 1.4 GB / 171 .js / 452K LOC) + `docs/1.0-release/1.0-blocker-issue-template.md`

**关键决策**: 14 new crate 1:1 翻译 v0.9.21 1.4GB / 171 .js / 452K LOC (5 P0 MCP + 3 估缺核心 + 2 工具 + 2 基础设施 P0 + 2 SDK stub). 1 TS = 1 Rust crate, 0 重设计, 0 业务修改.
...
| 2 | v2 / v4 / v4.1 LOCKED | 0 改 (本文件仅引用) | 12/12 (0012 前代产品 1:1 翻译) | 0/30 触发改 v2/v4/v4.1 | ✅ |
...
- `docs/adr/0012-前代产品-reverse-engineering.md` (前代产品 0.9.21 1:1 翻译)
