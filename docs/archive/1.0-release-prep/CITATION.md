...
Source:         续 根 README 草稿 03-citation.md + DEPENDENCY §5 + ROADMAP.md §R19 关键产物 + docs/adr/0010-6-philosophy-anchors.md 175 行 + 借鉴报告 (VCP 19 文件 / 前代产品 0.9.21 / Yinta / Hermes 团队 / golutra 6 state)
...
> **性质**: Apeireth v1.0.0 完整学术引用指南草稿. 含 **2 BibTeX entry** (apeireth2026 主 + apeireth-r20-2026 release) + **5 前身致敬** (前代产品 0.9.21 / VCPChat / Yinta fork / Hermes 团队 / m3-hallucination-defense) + **6 哲学锚 1 跳表** (S-1/S-2/O-2/O-3/O-4/O-5) + **3 学术引用方式** (软件/数据集/方法) + **Zenodo DOI 流程** (R21 续) + **致谢前人** (3 段) + **引用样例** (论文/学位/基金/标准).
>
...
> - **S-1** 走在前人经验上 (北极星): 借 Zenodo (业界软件 DOI 标准) + ORCID (学者 ID) + BibTeX (学术引用业界惯例) + 5 前身 (前代产品 0.9.21 / VCPChat / Yinta / Hermes / m3) 致敬
...
Apeireth v1.0.0 学术引用 = **2 BibTeX entry** (apeireth2026 主 + apeireth-r20-2026 release) + **5 前身致敬** (前代产品 0.9.21 / VCPChat / Yinta fork / Hermes 团队 / m3-hallucination-defense) + **6 哲学锚 1 跳表** (S-1/S-2/O-2/O-3/O-4/O-5) + **3 学术引用方式** (软件/数据集/方法) + **Zenodo DOI 流程** (R21 续) + **引用样例** (论文/学位/基金/标准 4 类) + **致谢前人** (3 段).

| 维度 | 数据 |
|------|------|
| **2 BibTeX entry** | ✅ apeireth2026 (主) + apeireth-r20-2026 (release tag) |
| **5 前身致敬** | ✅ 前代产品 0.9.21 (前身商业版) + VCPChat (Electron 19 文件) + Yinta (权限分心) + Hermes 团队 (R11 借鉴) + m3-hallucination-defense (24 LOCKED 守门) |
...
| # | 项目 | 时间 | 关系 | 协议 | 致敬 | 链接 |
|---|------|------|------|------|------|------|
| **1** | **前代产品 0.9.21** (前身商业版) | 2024-2025 | 67 crate 1:1 翻译来源 | Apache-2.0 | 主身前身, 商业版 → R14 Rust 重写源头 | [docs/adr/0012-前代产品-reverse-engineering.md](../../docs/adr/0012-前代产品-reverse-engineering.md) |
...
| 锚 | 名称 | 核心 | 反模式 | 论文对应 |
|----|------|------|--------|---------|
| **S-1** | 走在前人经验上 (北极星) | 平台中立 + 中央 AI 主体性 + 私域 = 栖居地; 借 3 架构 LOCKED + VCPChat 19 文件 + 前代产品 0.9.21 67 crate 1:1 翻译 | 自造 parser / 自造 runtime / 拒绝 serde | "Standing on the shoulders of giants" (Bernard of Chartres, 12 世纪) |
...
### §7.1 主身前身: 前代产品 0.9.21 (Apache-2.0)

> 本项目基于 **前代产品 0.9.21** 商业版 (2024-2025, Apache-2.0) 1:1 翻译为 R14 Rust 重写, 保留 67 crate 工程结构, 1 跳可达 `docs/adr/0012-前代产品-reverse-engineering.md`. 致敬原版 67 crate 工程师团队的工程哲学.
...
| **0 重复造轮子** | 借 Zenodo (业界软件 DOI 标准) + ORCID (学者 ID) + BibTeX (学术引用) + 5 前身 (前代产品 0.9.21 / VCPChat / Yinta / Hermes / m3) 业界惯例 | ✅ |
...
- [docs/adr/0012-前代产品-reverse-engineering.md](../../docs/adr/0012-前代产品-reverse-engineering.md) — 前代产品 0.9.21 前身
