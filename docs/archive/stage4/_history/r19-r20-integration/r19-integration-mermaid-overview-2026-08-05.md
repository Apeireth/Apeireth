...
- **41 份文档就位** (per `r19-integration-doc-index-2026-08-05.md` §1.1): 25 docs/ + 14 reports/, 跨 2 个工作树 (Apeireth 仓库 + 前代产品 工作树), 散落在 6 个 docs/ 子目录 + 2 个 reports/ 子目录。
...
graph TD
    ...
    %% ============== 蓝图类 🟦 ==============
    blueprint["前代产品-integration-blueprint-r19-plus<br/>(蓝图 0)"]:::blueprint
    r20_finalize["r20-product-finalize<br/>(R20 路线图)"]:::blueprint
    gam["global-architecture-map<br/>(13 张 Mermaid)"]:::blueprint

    %% ============== ADR 类 🟩 ==============
    adr0010["adr/0010-mcp-from-前代产品-agentmcpserver<br/>(mcp 翻译)"]:::adr
    ...
    %% ============== 资产类 🟧 ==============
    tauri_assets["tauri-assets-from-前代产品<br/>(13 项 T-001~T-013)"]:::asset
    tauri_collab["tauri-team-collab-sop<br/>(5 步 SOP)"]:::asset
    glossary["glossary-前代产品-additions<br/>(8 词条)"]:::asset
    ...
    %% ============== reports/ 类 ⚫ ==============
    rep_arch["reports/前代产品-architecture"]:::report
...
graph TD
    ...
    docidx --> orig_idx["原 35 份 R19+ 集成文档:<br/>22 docs/ (Apeireth 仓库)<br/>+ 13 reports/ (前代产品 工作树)"]:::report
...
| 蓝图 (docs/stage4) | 2 | 前代产品-integration-blueprint / global-architecture-map |
...
| 资产 (docs/stage4) | 3 | tauri-assets / tauri-collab-sop / glossary-前代产品 |
...
| **docs/ 小计** | **25** | - |
| reports/ 早期 | 3 | 前代产品-architecture / apeireth-crate-api / apeireth-platform-modules |
...
| 2026-08-05 12:00 | 前代产品 验证失败, 改路线 | Mavis |
