...
> - `docs/stage4/前代产品-integration-blueprint-r19-plus-2026-08-05.md` (R19+ 集成, A 方案已拍板 2026-08-05)
...
> - 10 份 reports/ (council / crate-api / graph-pipeline / mcp-14-tool / platform-modules / protocol-4-adapter / session-vector-asi / supervisor-tool-rules / 前代产品-architecture / tauri-roadmap)
...
R20 阶段 1-2 = R19+ 集成蓝图的工程化落地. 衔接关系 (per `前代产品-integration-blueprint-r19-plus-2026-08-05.md`):
...
diff <(curl -s https://raw.githubusercontent.com/前代产品-org/前代产品/main/supervisorPrompt.ts) crates/apeireth-team-lead/src/prompt.rs | wc -l
...
| **R19+ 前代产品 集成蓝图** | A 方案决策 + mid-task bug + 命名空间 | `docs/stage4/前代产品-integration-blueprint-r19-plus-2026-08-05.md` |
...
> **修正**: 用户描述 "15 份 reports", 实际 `` 下 10 份.
...
| `前代产品-architecture-2026-08-05.md` | 前代产品 19 模块架构 | 阶段 1.2 (1:1 翻译 supervisorPrompt.ts) |
...
| `前代产品-integration-blueprint-r19-plus-2026-08-05.md` | §1.3 (衔接) / §2.3 (mcp::team) / §2.4 (mid-task bug) / §5.1 (命名空间) |
