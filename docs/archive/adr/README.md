...
| 0012 | 前代产品 0.9.21 1:1 翻译 | 🟢 Accepted | [0012-前代产品-reverse-engineering.md](0012-前代产品-reverse-engineering.md) |
...
原 R14 阶段 12 条历史 ADR (双洋葱统一体 / CLI ↔ Session API 绑定 / Trait 互锁 22 枚举 / 权限洋葱版本化 / 风险等级 M1-M12 阈值 / 集成 rebase-skip 策略 / 兼容组件层 / Feature gating pybridge / 集成 rebase-skip 政策 v2 / MCP from 前代产品 / team-lead supervisor prompt 翻译 / team-lead council 协作), 因 R20 阶段 6 1.0 release 收口重排 0001-0012 而归档。

**保留原因**: 历史决策可追溯; 接手者读 archive/r14/ 即可知 R14 → R20 演进。

### 3.2 R20 重排前 batch (9 条) — 归档到 [`archive/r20-pre-renumber/`](archive/r20-pre-renumber/)

原 R20 阶段 1-6 拍板的 9 条 ADR (0013-apeireth-rust-1.0 / 0016-d-02 / 0017-d-01 / 0019-d-06 / 0020-d-07 / 0021-6-philosophy / 0022-tui-thin-client / 0023-前代产品 / 0024-1.0-release-checklist), 因 R20 阶段 6 1.0 release 收口重排 0001-0012 而归档 (新 0001-0012 引用新编号, 旧 0013-0024 内容保留)。
