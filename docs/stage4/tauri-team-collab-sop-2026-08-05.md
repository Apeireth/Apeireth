...
> **依据**: 主人 2026-08-04 19:53 砍前端决策 + R17 战略 3 标记 + 13 项 Tauri 资产沉淀 (`tauri-assets-from-前代产品-2026-08-05.md`).
...
- 13 项 Tauri 资产 (我们沉淀, 见 `tauri-assets-from-前代产品-2026-08-05.md`)
...
per `docs/stage4/tauri-assets-from-前代产品-2026-08-05.md`:
...
**总计**: 13 项, ~6272 LOC, 全部 前代产品 v0.9.21 实战检验过.
...
| **13 项 Tauri 资产** | `docs/stage4/tauri-assets-from-前代产品-2026-08-05.md` | R20 阶段 4 已沉淀 |
...
| **13 项 Tauri 资产** | Apeireth 团队沉淀 | Tauri 团队按表复用 | `tauri-assets-from-前代产品-2026-08-05.md` (R20 阶段 4) | 已就绪, Tauri 阶段查表 |
| **11 类 IPC 映射** | Apeireth 团队 (OpenAPI 决定) | Tauri 翻译成 `#[tauri::command]` | R20 阶段 1 (跟 `docs/adr/0010-mcp-from-前代产品-agentmcpserver.md` 同周期) | OpenAPI 工具链 |
...
**文档**: `docs/stage4/tauri-assets-from-前代产品-2026-08-05.md` ✅ (2026-08-05 完工)

**Tauri 团队 lead 行动**:
- 接手时第一件事: 通读 §2 13 行表, 确认"我要 X → T-XXX → 前代产品 哪个文件"
...
- 重点看 `tauri-assets-from-前代产品-2026-08-05.md` 增改行 (T-XXX ✅/❌ 标记)
...
3. **13 项 Tauri 资产全部维护在 `tauri-assets-from-前代产品-2026-08-05.md`** (不要分散)
...
- ✅ 全部在 `tauri-assets-from-前代产品-2026-08-05.md` 一张表
- ✅ 新增 T-XXX 行 (按 8 列格式填)
- ✅ 用过的项标 ✅, 弃用标 ❌ + 原因
...
| **5** | **13 项 Tauri 资产** (T-001 ~ T-013, ~6272 LOC) | `docs/stage4/tauri-assets-from-前代产品-2026-08-05.md` | Apeireth (technical_writer) | Tauri (按表 1:1 翻译) | 已就绪 (2026-08-05) |
...
1. 接手时**先读** `tauri-assets-from-前代产品-2026-08-05.md` (13 项表) — 知道 前代产品 已实现什么
...
| **Tauri 团队用了 v1 弃用 API** | 前代产品 V1 PTY 路径已弃用, Tauri 团队不知道 | ① 资产表明确标 V1 弃用 ② §3 蓝图引用 "⚪ 沉淀" 行 ③ Tauri 团队必读 `tauri-assets-*.md` §1.3 沉淀范围 |
...
- **13 项 Tauri 资产**: `docs/stage4/tauri-assets-from-前代产品-2026-08-05.md` (Tauri 团队 lead 必读)
- **集成蓝图**: `docs/stage4/前代产品-integration-blueprint-r19-plus-2026-08-05.md` (R19+ 战略, §5.2 集成映射)
- **apeireth-sdk 缺失分析**: `docs/stage4/apeireth-sdk-gap-analysis-2026-08-05.md` (本周期, 3 SDK 5 步实施方案)
- **ADR 0010~0012**: `docs/adr/0010-mcp-from-前代产品-agentmcpserver.md` (apeireth-mcp 来源) + 0011 (不修改承诺) + 0012 (R20 范围)
