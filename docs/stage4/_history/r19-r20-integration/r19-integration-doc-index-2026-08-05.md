...
>
> **诚实登记** (S-2 17:43):
> 1. 22 docs/ + 13 reports/ = 35 份是 R19+ 集成期口径. Apeireth 仓库实际只含 22 docs/ (per `r19-integration-wrap-up-2026-08-05.md` §1.1), 13 reports/ 在 前代产品 工作树 (``).
...
- **35 份文档就位**: 22 docs/ (Apeireth 仓库) + 13 reports/ (前代产品 工作树), 跨 2 个工作树, 散落在 6 个 docs/ 子目录.
...
| # | 路径 | 大小 | 作用 |
|---|------|-----:|------|
| 1 | `docs/stage4/前代产品-integration-blueprint-r19-plus-2026-08-05.md` | 60.9KB | 蓝图 0 (R19+ 集成总蓝图) |
...
| # | 路径 | 大小 | 作用 |
|---|------|-----:|------|
| 4 | `docs/adr/0010-mcp-from-前代产品-agentmcpserver.md` | 12.7KB | mcp 翻译 (前代产品 → Apeireth) |
...
| # | 路径 | 大小 | 作用 |
|---|------|-----:|------|
| 14 | `docs/stage4/tauri-assets-from-前代产品-2026-08-05.md` | 15.9KB | 13 项 T-001~T-013 Tauri 资产 |
| 15 | `docs/stage4/tauri-team-collab-sop-2026-08-05.md` | 22.8KB | Tauri 团队对接 5 步 SOP |
| 16 | `docs/stage4/glossary-前代产品-additions-2026-08-05.md` | 11.1KB | 8 词条 (前代产品 → Apeireth 词表) |
...
## §3 13 reports/ 总览 (前代产品 工作树)

### §3.1 早期分析 (3 份)

| # | 路径 | 大小 | 作用 |
|---|------|-----:|------|
| 1 | `reports/前代产品-architecture-2026-08-05.md` | 52.9KB | 前代产品 架构 19 模块 |
...
| 13 项 Tauri 资产 (T-001~T-013) | per `tauri-assets-from-前代产品-2026-08-05.md` | tauri-assets |
