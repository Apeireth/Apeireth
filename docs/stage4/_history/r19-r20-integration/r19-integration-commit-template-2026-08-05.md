...
| **13 reports/** | 13 | `` | 1 前代产品 架构 + 11 Apeireth 现状 + 1 总收口 |
...
Refs: docs/adr/0010-mcp-from-前代产品-agentmcpserver.md
...
Refs: docs/adr/0011-apeireth-team-lead-supervisor-prompt-translation.md
Refs: docs/stage4/前代产品-integration-blueprint-r19-plus-2026-08-05.md §1.3
...
```
docs: 8 词条合并到 GLOSSARY.md (per glossary-前代产品-additions 草稿)

- 修改 1 份: GLOSSARY.md (顶层 LOCKED, 但本词条属"增量添加", 主人拍板后改)
- 拍板: 8 词条合并时机 (主人 2026-08-XX HH:MM, per glossary-前代产品-additions §8)
- ⚠️ 提示: GLOSSARY.md 是 8 项不修改承诺 #3 之一, 改前必须主人拍板

Refs: docs/stage4/glossary-前代产品-additions-2026-08-05.md
...
| **D-03** | 24 维具体分类名 (continuity / salience / identity / philosophy guard / transferability) | 前代产品 §7.4 + asi 24dim §1.4 | 模板 D + 模板 A (asi public API) | 🟡 R20 阶段 1 必拍 |
...
```
- 拍板: 24 维具体分类名 (continuity / salience / identity / philosophy guard / transferability) (主人 2026-08-XX HH:MM, per 前代产品/reports/apeireth-asi-24dim-api-2026-08-05.md §1.4)
```
...
- `docs/stage4/前代产品-integration-blueprint-r19-plus-2026-08-05.md` (R19+ 集成蓝图根)
...
- 13 reports/ (1 前代产品 架构 + 11 Apeireth 现状 + 1 总收口)
