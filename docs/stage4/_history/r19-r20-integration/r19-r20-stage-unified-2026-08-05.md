...
- 阶段 1-3 跟 R19+ 集成蓝图 (前代产品-integration-blueprint-r19-plus) 强协同
...
- `reports/r19-integration-wrap-up-2026-08-05.md` §1.4 (5 阶段路线总览) + §2.2 (R19+ 5 阶段 Gantt) — ⚠️ 此文件被多处引用但实际路径在 ``, 不在 Apeireth-rust 仓库内 (per 互检报告 §8.2 L-05 断链根源)
