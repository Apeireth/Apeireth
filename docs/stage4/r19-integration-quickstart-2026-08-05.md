...
| **13 份 reports/** | 13 | `` | 1 前代产品 架构 + 11 Apeireth 现状 + 1 总收口 |
| **总额** | **30** | 跨 2 个工作树 | 覆盖 R19+ 集成全维度 |

> ⚠️ 跨工作树 (Apeireth-rust 仓库 + 前代产品 工作树) 是 R19+ 集成的特殊结构. **Apeireth 仓库只有 17 docs/**, 13 reports/ 全部在 前代产品 工作树 (per `r19-integration-wrap-up-2026-08-05.md` §1.1).
...
| # | 必读 | 路径 | 估时 |
|---|------|------|------|
| 1 | 集成蓝图 (60.9KB) | `docs/stage4/前代产品-integration-blueprint-r19-plus-2026-08-05.md` | 30min |
| 2 | ADR-0010 mcp 翻译 | `docs/adr/0010-mcp-from-前代产品-agentmcpserver.md` | 10min |
...
| # | 必读 | 路径 | 估时 |
|---|------|------|------|
| 1 | 13 项 Tauri 资产 | `docs/stage4/tauri-assets-from-前代产品-2026-08-05.md` | 15min |
...
| 2 | 13 项 Tauri 资产 | `docs/stage4/tauri-assets-from-前代产品-2026-08-05.md` | 15min |
...
| # | 必读 | 路径 | 估时 |
|---|------|------|------|
| 1 | 集成蓝图 §8 10 决策 | `docs/stage4/前代产品-integration-blueprint-r19-plus-2026-08-05.md` §8 | 20min |
...
| frontend_engineer | `tauri-assets-from-前代产品` §1 (13 项 T-001~T-013) | 13 项资产对接 | 1 天 |
...
| 🎨 **frontend_engineer** | 2 | **30min** | 13 项 T-001~T-013 资产对接 | `tauri-assets-from-前代产品` §1 |
...
| # | 文件 | 大小 | 谁必读 | 估时 |
|---|------|-----:|--------|-----:|
| 1 | `docs/stage4/前代产品-integration-blueprint-r19-plus-2026-08-05.md` | 60.9KB | **所有角色** | 30min |
...
- 前代产品 §7.4 + apeireth-asi 24 dim: 1 项 (#3)
...
| **R-Q8** 跨工作树 (Apeireth + 前代产品) → 文档散乱 | 🟡 中 | §1.2 注明 17 docs/ 在 Apeireth, 13 reports/ 在 前代产品 | 文档引用时 |
...
**总收口 + 索引**:
- [R19+ 集成收口报告 (24 份核心文档地图)](file:///)
- [前代产品 集成蓝图 (R19+ 根)](file:///.openclaw/workspace/promethean/Apeireth-rust/docs/stage4/前代产品-integration-blueprint-r19-plus-2026-08-05.md)
...
backend_engineer (5):
- [前代产品 集成蓝图](file:///.openclaw/workspace/promethean/Apeireth-rust/docs/stage4/前代产品-integration-blueprint-r19-plus-2026-08-05.md)
- [ADR-0010 apeireth-mcp 翻译](file:///.openclaw/workspace/promethean/Apeireth-rust/docs/adr/0010-mcp-from-前代产品-agentmcpserver.md)
...
frontend_engineer (2):
- [Tauri 资产沉淀 13 项](file:///.openclaw/workspace/promethean/Apeireth-rust/docs/stage4/tauri-assets-from-前代产品-2026-08-05.md)
...
主人 (3 + 12 项):
- [前代产品 集成蓝图 §8 10 决策](file:///.openclaw/workspace/promethean/Apeireth-rust/docs/stage4/前代产品-integration-blueprint-r19-plus-2026-08-05.md)
- [R20 路线图 §11 3 拍板](file:///.openclaw/workspace/promethean/Apeireth-rust/docs/roadmap/r20-product-finalize-2026-08-05.md)
- [总收口 §7 10 项 + commit-template §5.1 12 项](file:///)
