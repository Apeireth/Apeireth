...
| **真生产对照** | VCP `Plugin.js:543-750,759-788,817-1170,1571-1628` + VCP `modules/vcpLoop/toolCallParser.js:1-268` + VCP `Plugin/SciCalculator/pluginon:1-32` (32 字段 manifest) + VCP `Plugin/AgnesVideoGen/pluginon:1-82` (82 字段 manifest) + VCP `Plugin/LightMemo/pluginon:1-51`。Apeireth 自家: `apeireth/v1001_vcp_six_plugins_full.py` (六类插件协议详解) + `apeireth/v1009_web_ui.py` (FastAPI 路由) + `apeireth/v1016_rest_gateway.py` (REST gateway)。 |
