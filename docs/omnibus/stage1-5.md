...
- [`docs/stage4/`](../../stage4/) — 50+ 文件 (~1.5MB)
  ...
  - **R19+ 集成期** (8/5 增量):
    ...
    - `前代产品-integration-blueprint-r19-plus-2026-08-05.md` (64.2KB)
    - `前代产品-branch-coverage-audit-2026-08-05.md` (47.5KB)
    ...
    - `glossary-前代产品-additions-2026-08-05.md` (11.3KB)
    - `organ-public-api-survey-2026-08-06.md` (3.6KB)
    - `tauri-assets-from-前代产品-2026-08-05.md` (16.1KB)
