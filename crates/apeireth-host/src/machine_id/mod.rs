...
// SMBios = System Management BIOS, v0.9.21 1:1 用作 fallback 指纹源.
...
/// 派生 UUID v5 (1:1 翻译 v0.9.21 `crypto.createHash('sha256').digest()`).
///
/// Algorithm:
...
/// - UUID v5 是标准 RFC 4122, 跟 v0.9.21 node uuid.v5 兼容
...
///
/// 1:1 翻译 v0.9.21 `getMachineId-unsupported.js` 5 文件路由表.
#[must_use]
...
///
/// 1:1 翻译 v0.9.21 `crypto.createHmac('sha256', PLATFORM_NAME).update(raw).digest('hex')`.
...
// 1:1 翻译 v0.9.21 `getMachineId`, 给监控/审计用.
...
// 1:1 翻译 v0.9.21 `getMachineId-fingerprint.js`, 给 audit 用.
// ============================================================================
