//! BSD 平台: 1:1 翻译 `getMachineId-bsd`.
//!
//! ## 1:1 翻译表 (per `getMachineId-bsd` ~200 LOC)
//!
...
use super::{MachineIdError, MachineIdResultStd, BSD_HOSTID_PATH, BSD_KENV_COMMAND, BSD_KENV_VAR};
