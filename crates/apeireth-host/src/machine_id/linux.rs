//! Linux 平台: 1:1 翻译 `getMachineId-linux`.
//!
//! ## 1:1 翻译表 (per `getMachineId-linux` ~200 LOC)
//!
...
use super::{MachineIdError, MachineIdResultStd, LINUX_DBUS_PATH, LINUX_DMI_PATH, LINUX_ETC_PATH};
