...
pub use canonical::{
    is_write_or_execute_capability, with_memory_context_projection, CanonicalMemoryTypedSink,
    ...
    ReflexionModule, RepoModule, SearchModule, SelfAssessmentModule, ShellModule,
    ...
    REFLEXION_MODULE_ID, SELF_ASSESSMENT_MODULE_ID,
};
