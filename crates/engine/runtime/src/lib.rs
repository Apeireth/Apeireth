...
pub use canonical::{
    budget_context_blocks, operation_fingerprint, operation_fingerprint_with_invocation,
    plugin_ids, AgentModule, ApprovalDecision, ApprovalResolution, ApprovalStatus, BehaviorModule,
    CapabilityProvider, CapabilityRegistry, CompositeEventSink, CompositeRuntimeEventSink,
    ContextBlock, ContextProjectionError, ContextProjector, ExecutionTrace, HookPoint,
    ...
    TurnRequest, TurnResponse, DEFAULT_CONTEXT_BUDGET_CHARS, DEFAULT_MAX_INVOCATION_DEPTH,
