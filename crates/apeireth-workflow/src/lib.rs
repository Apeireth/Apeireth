...
//!
//! **目标**: 1:1 翻译 v0.9.21 `WorkflowGenerator-BQCQ_KQx.js`
...
//! - 2. `` (480 行, §3 表 apeireth-workflow 估 4h)
//! - 3. v0.9.21实查: `安装包WorkflowGenerator-BQCQ_KQx.js` (65200 bytes, 1 主导出 + 8 节点类型 + 4 警告守门)
...
/// 战役 R20 阶段 1 实际借鉴 v0.9.21 WorkflowGenerator 关键工具数
...
///
/// 1:1 翻译 v0.9.21 4 警告守门 + 拓扑排序 + 节点执行错误.
#[derive(Debug, Error)]
...
///
/// v0.9.21用字符串 `'agent' / 'loop' / 'transform' / 'condition' / 'team' / 'mission' / 'watch' / 'review'`;
...
///
/// v0.9.21每种节点类型有自己的 `*Config` 对象 (claudeConfig / loopConfig / conditionConfig / ...);
