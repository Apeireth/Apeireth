//! # Health check 3 端点
//!
//! 1:1 翻译 v0.9.21 `out/main` observability 集成 (per blueprint §2.5.3).
...
mod tests {
    ...
    async fn health_check_metrics_endpoint_returns_count() {
        let samples = vec![
            MetricSample::new("requests_total", crate::MetricKind::Counter, 1.0),
            MetricSample::new("requests_total", crate::MetricKind::Counter, 2.0),
        ];
