//! tree-sitter Demo (1:1 翻译 v0.9.21 tree-sitter 集成流程).
//!
...
//! ## 6 哲学 anchor 验证
//!
//! - S-1: 1:1 翻译 v0.9.21 tree-sitter 集成 (8 Language + 8 工具白名单 + LSP 6 method)
//! - S-2: 用商业版 `tree-sitter-*` 实查估 2000 LOC 总, skeleton 阶段估 600 行
