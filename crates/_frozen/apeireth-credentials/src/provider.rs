...
//!
//! 1:1 翻译 v0.9.21 `credentials` 集成面. 5 Provider 各有独立实现,
...
//! ## 6 哲学 anchor 穿透
//!
//! - **S-1 北极星导向**: 5 Provider 1:1 翻译 v0.9.21, 0 业务重设计
...
///
/// 1:1 翻译 v0.9.21 5 个 credential provider. 顺序固定, 不可运行时增删.
...
///
/// 1:1 翻译 v0.9.21 `out/main` 中 5 个 credential provider 的核心接口.
#[async_trait]
