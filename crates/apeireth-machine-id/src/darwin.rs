//! macOS 平台: 1:1 翻译 `getMachineId-darwin`.
//!
//! ## 1:1 翻译表 (per `getMachineId-darwin` ~200 LOC)
//!
...
use crate::{MachineIdError, MachineIdResultStd, DARWIN_IOREG_ARGS, DARWIN_IOREG_COMMAND};
