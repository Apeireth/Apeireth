//! Windows 平台: 1:1 翻译 `getMachineId-win`.
//!
//! ## 1:1 翻译表 (per `getMachineId-win` ~200 LOC)
//!
...
use crate::{MachineIdError, MachineIdResultStd, WIN_REG_QUERY_ARGS, WIN_REG_QUERY_COMMAND, WIN_WMI_ARGS, WIN_WMI_COMMAND};
