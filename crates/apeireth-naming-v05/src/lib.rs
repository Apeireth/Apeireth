...
//! 6. lineage      前代产品-0.9/apeireth-0.14/apeireth-1.0/apeireth-2.0
//! ```
//!
//! ## 命名格式
//!
...
//! - `apeireth:9.GP.dialogue.audio.low.skeleton.前代产品-0.9` (level=9, class=GP, dialogue/audio, lineage=前代产品-0.9)
//!
//! ## 模块结构
//!
...
// │  4 │ safety       │ low/medium/high/critical                   │
// │  5 │ completeness │ skeleton/partial/complete/production       │
// │  6 │ lineage      │ 前代产品-0.9/apeireth-0.14/...             │
// └────┴──────────────┴────────────────────────────────────────────┘
//
...
//   `apeireth:9.GP.dialogue.audio.low.skeleton.前代产品-0.9`
//
// ============================================================================
// 守门 4 道 (per K-1 强校验)
// ============================================================================
