...
| Crate | 阶段 | 角色 | 状态 |
|-------|------|------|------|
| `apeireth-sdk-livekit` (LOCKED) | R20 阶段 4 | v0.9.21 1:1 翻译 stub (client-side: connect/disconnect/publishTrack/subscribe/setCameraEnabled/setMicrophoneEnabled) | LOCKED baseline 16:34:11, 0 改 |
