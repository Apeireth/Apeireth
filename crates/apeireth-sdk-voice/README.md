...
Voice 语音 SDK stub (1:1 翻译 `@anthropic-ai/voice` v0.9.21).

## 1:1 翻译 v0.9.21 API 表面

| 模块 | v0.9.21 | R20 阶段 4 stub |
|------|---------------|------------------|
...
`"apeireth"` (per R20 设计拍板, 1:1 翻译 v0.9.21品牌一致).
