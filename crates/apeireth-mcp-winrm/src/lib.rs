//! # apeireth-mcp-winrm
//!
//! WinRM MCP Server (1:1 翻译 v0.9.21 `out/main/mcp/WinRMMcpServer.js` ~64KB)
//!
...
//! ## 6 哲学 anchor 穿透
//!
//! - **S-1 北极星导向**: 1:1 翻译 v0.9.21 WinRM (~64KB), 0 业务重设计
...
//! 2. ``
//! 3. v0.9.21 `out/main/mcp/WinRMMcpServer.js` (~64KB)
