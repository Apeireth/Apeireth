...
//!
//! 凭证子系统的统一错误类型, 1:1 翻译 v0.9.21 `out/main` 错误码体系.
...
//! 3. **每个变体 1:1 翻译 v0.9.21**: 对齐 SDK 错误码, 方便 R21+ 真接时迁移
...
//! ## 6 哲学 anchor 穿透
//!
//! - **S-1 北极星导向**: 错误码 1:1 翻译 v0.9.21, 0 业务重设计
...
///
/// 1:1 翻译 v0.9.21 `credentials` 错误码.
...
pub enum CredentialsError {
    ...
    #[error("[not_implemented] {0}: R20 阶段 6 skeleton, R21+ 真接 v0.9.21 credentials")]
