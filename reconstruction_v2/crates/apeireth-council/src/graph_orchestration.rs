...
//!
//! **职责**:
//! - 把 4 协作模式包装成 `graph_runtime::Node` impl
...
//!
//! **0 漂移**:
//! - 0 改 graph_runtime (v2 本地 runtime)
...
impl Node for CollaborationNode {
    ...
    fn run(&self, state: &mut State) -> crate::graph_runtime::Result<NodeOutput> {
