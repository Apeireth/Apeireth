//! # apeireth-repo-scan
//!
//! Repo Scanner (1:1 翻译 v0.9.21 `RepoScanAdapter` ~7KB
//! + `RepoAnalyzer` ~6KB). R20 阶段 4 续 P1 估缺.
//!
...
//!
//! - **1:1 翻译**: 8 大功能严格按 v0.9.21切分, O-5 不假装.
...
/// Repo Scan schema version (跟 v0.9.21 `ScanResult.schema_version` 字段 1:1).
