...
use crate::compat::{Episode, IdentityCard, Note, Session};
use rusqlite::Connection;
use serde::{Deserialize, Serialize};
use thiserror::Error;

// v1-style type aliases (Episode/Note/Session) — local definition to avoid breaking
// v2 core\'s Episode/Note/Session API (different shapes).
pub mod compat;
...
pub use crate::compat::Episode as CoreEpisode;
...
// v2 note: apeireth-memory-extensions crate is not present in v2 workspace; re-export omitted.
