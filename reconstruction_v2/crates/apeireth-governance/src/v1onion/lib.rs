...
// =============================================================================
// v1-onion reconstruction preamble
// =============================================================================
//
// The body of this file (everything after this preamble) is the VERBATIM
// transcription of v1 apeireth-onion/src/lib.rs. It references v1-era
// apeireth_core types (HumanAuthority / PermissionLayer / PermissionOnion /
// PrincipleLayer / PrincipleOnion / HAMode) that no longer exist in v2.
//
// To preserve the v1 source for audit/reference WITHOUT breaking the v2
// build, the body is gated behind #[cfg(feature = "v1-onion")] via the
// mod.rs. Default build: this module compiles to no-op stubs. With the
// feature: compilation will fail until v2 apeireth_core is extended with the
// missing types (the body is the spec).

// Broken v1 imports (commented out — see preamble above):
// use apeireth_core::{
...
// v1-era type stubs (for the default build). With `--features v1-onion`,
// the v1 imports would take precedence if the types were re-added.
#[cfg(not(feature = "v1-onion"))]
pub(crate) type CorePrincipleOnion = ();
#[cfg(not(feature = "v1-onion"))]
pub(crate) type CorePermissionOnion = ();
#[cfg(not(feature = "v1-onion"))]
pub(crate) type CorePrincipleLayer = ();
#[cfg(not(feature = "v1-onion"))]
pub(crate) type CorePermissionLayer = ();
#[cfg(not(feature = "v1-onion"))]
pub(crate) type HumanAuthority = ();
#[cfg(not(feature = "v1-onion"))]
...
#[cfg(not(feature = "v1-onion"))]
pub(crate) struct ElectronicRing {
    pub(crate) e_layer: (),
    pub(crate) s_layer: (),
    pub(crate) a_layer: (),
    pub(crate) m_layer: (),
...
#[cfg(not(feature = "v1-onion"))]
pub(crate) struct OnionAction;
#[cfg(not(feature = "v1-onion"))]
pub(crate) const ELECTRONIC_RING_LEN: usize = 11;
#[cfg(not(feature = "v1-onion"))]
pub(crate) const PERMISSION_LAYERS_OUTER_IN: [(); 6] = [(); 6];
#[cfg(not(feature = "v1-onion"))]
pub(crate) const PRINCIPLE_LAYERS_OUTER_IN: [(); 5] = [(); 5];
#[cfg(not(feature = "v1-onion"))]
pub(crate) enum PermissionLayerKind {
    L0, L1, L2, L3, L4, L5,
}
#[cfg(not(feature = "v1-onion"))]
pub(crate) enum PrincipleLayerKind {
    E, S, A, M, O,
}

// =============================================================================
// VERBATIM v1 body (gated via mod.rs `#[cfg(feature = "v1-onion")]`).
// Each line below is preserved verbatim from the v1 source; commented out to
// keep the v2 build green.
// =============================================================================
