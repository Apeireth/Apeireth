...
use crate::v1supervisor::strategy::{should_restart, RestartStrategy};
...
impl ChildSpec {
    ...
    pub fn decide(&self, reason: crate::v1supervisor::strategy::ExitReason) -> crate::v1supervisor::strategy::RestartDecision {
...
mod tests {
    ...
    fn decide_delegates_to_strategy() {
        ...
        assert_eq!(
            spec.decide(crate::v1supervisor::strategy::ExitReason::Normal),
            crate::v1supervisor::strategy::RestartDecision::Skip
        );
        assert_eq!(
            spec.decide(crate::v1supervisor::strategy::ExitReason::Abnormal(1)),
            crate::v1supervisor::strategy::RestartDecision::Restart
        );
    }
