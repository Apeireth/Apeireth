...
_Last updated_: 2026-10-06 (文档对账：18-crate 范围核验——新增 `apeireth-guard` 安全边界；测试基线已复核重跑 = **3418 passed / 0 failed / 19 ignored**（`cargo test --workspace`，129 suites，exit 0；2026-10-06 W2 接线批后实测）；workspace.version 2.0.0-rc.1、仓库 URL `Apeireth/Apeireth` 不变)
